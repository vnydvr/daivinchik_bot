...
town = ["example_1", "example_2"] #ОБЯЗАТЕЛЬНО С МАЛЕНЬКОЙ БУКВЫ И БЕЗ ОКОНЧАНИЯ (пример: Москва -> москв) {учитывайте что некоторые не умные люди пишут название города с ошибками либо писать район вместо города}
